...
import {
  useIsoLayoutEffect,
  useStableCallback
} from "./chunk-W5Q4KMQG.js";
import {
  EMPTY_OBJECT,
  useMergedRefs,
  useRenderElement
} from "./chunk-KQYMR6RM.js";
import {
  require_react
...
var SwitchRoot = React4.forwardRef(function SwitchRoot2(componentProps, forwardedRef) {
  const {
    checked: checkedProp,
    className,
    defaultChecked,
  ...
  const switchRef = React4.useRef(null);
  ...
  const inputProps = React4.useMemo(() => mergeProps(
    {
      checked,
      disabled,
      id: hiddenInputId,
...
var SwitchThumb = React5.forwardRef(function SwitchThumb2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
